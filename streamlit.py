...
if more_opt == 'Yes' :
    ...
    if 'Bollinger' in indic_to_plot : 
        ...
        fig_indicators.add_trace(go.Scatter(x=df_i["Date"], y=df_i['Upper_bb'], mode='lines',  line = dict(shape = 'linear', color = 'goldenrod', dash = 'dot'),, name='Upper Bollinger Band', row=1, col=1)
        fig_indicators.add_trace(go.Scatter(x=df_i["Date"], y=df_i['Lower_bb'], mode='lines',  line = dict(shape = 'linear', color = 'goldenrod', dash = 'dot'),, name='Lower Bollinger Band', row=1, col=1)
