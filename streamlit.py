...
if more_opt == 'Yes' :
    ...
    if 'Bollinger' in indic_to_plot : 
        ...
        fig_indicators.add_trace(go.Scatter(x=df_i["Date"], y=df_i['Upper_bb'], mode='markers',  marker_symbol='-', name='Upper Bollinger Band', marker_color = 'goldenrod'), row=1, col=1)
        fig_indicators.add_trace(go.Scatter(x=df_i["Date"], y=df_i['Lower_bb'], mode='markers',  marker_symbol='-', name='Lower Bollinger Band', marker_color = 'goldenrod'), row=1, col=1)
